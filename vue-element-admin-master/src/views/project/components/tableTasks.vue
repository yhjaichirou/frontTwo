    ...
    >
      ...
      <el-table-column fixed="right" label="操作" width="180">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click.native.prevent="deleteRow(scope.$index, scope)" style="color:#f56c6c">
            移除
          </el-button>

          <el-button type="text" size="small" @click.native.prevent="handleTaskDetail(scope)">查看</el-button>
          <el-button type="text" size="small" @click.native.prevent="dbRow(scope)" style="color:#e6a23c">督办</el-button>
        </template>
      </el-table-column>
    </el-table>
