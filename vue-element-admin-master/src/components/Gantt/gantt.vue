<template>
  ...
  >
    <template v-if="!ganttOnly">
      <slot name="prv" />
      <el-table-column v-if="useCheckColumn" fixed type="selection" width="55" align="center" />
      <el-table-column v-if="useIndexColumn" fixed type="index" width="50" label="序号" />
      <el-table-column
        fixed
        label="名称"
        min-width="200"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <div v-if="useRealTime" :class="realDayGanttType(scope.row, month.full_date, 'months')" />
          </template>
        </el-table-column>
      </el-table-column>
    </template>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <div v-if="useRealTime" :class="realDayGanttType(scope.row, t.full_date, 'week')" />
          </template>
        </el-table-column>
      </el-table-column>
    </template>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <div v-if="useRealTime" :class="realDayGanttType(scope.row, t.full_date)" />
          </template>
        </el-table-column>
      </el-table-column>
    </template>
